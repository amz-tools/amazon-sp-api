...
| **console_warn_on_request_retry**<br>*optional* | boolean | false | Whether or not the client should print a console warning every time a request is retried after throttling. |
