  ...
  v1: {
    ...
    confirmCustomizationDetails: (req_params) => {
      ...
      return Object.assign(req_params, {
        ...
        api_path:
          "/messaging/v1/orders/" +
          req_params.path.amazonOrderId +
          "/messages/confirmCustomizationDetails",
        restore_rate: 1
      });
    },
    createConfirmDeliveryDetails: (req_params) => {
      ...
      return Object.assign(req_params, {
        ...
        api_path:
          "/messaging/v1/orders/" +
          req_params.path.amazonOrderId +
          "/messages/confirmDeliveryDetails",
        restore_rate: 1
      });
    },
    ...
    createNegativeFeedbackRemoval: (req_params) => {
      ...
      return Object.assign(req_params, {
        ...
        api_path:
          "/messaging/v1/orders/" +
          req_params.path.amazonOrderId +
          "/messages/negativeFeedbackRemoval",
        restore_rate: 1
      });
    },
    ...
    createConfirmServiceDetails: (req_params) => {
      ...
      return Object.assign(req_params, {
        ...
        api_path:
          "/messaging/v1/orders/" +
          req_params.path.amazonOrderId +
          "/messages/confirmServiceDetails",
        restore_rate: 1
      });
    },
