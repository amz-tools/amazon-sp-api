...
class SellingPartner {
  ...
  // req_params object:
  // operation:'<OPERATION_TO_CALL>', // Optional: The operation you want to request. Required if "full_path" is not defined.
  ...
  //   ...
  // },
  // full_path:'<FULL_PATH_OF_OPERATION>', // Optional: The full path of an operation. Required if "operation" is not defined.
  ...
  //   method:'GET' // The HTTP method to use. Required only if "full_path" is defined. Must be one of: "GET", "POST", "PUT" or "DELETE".
  // }
